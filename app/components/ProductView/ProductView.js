  ...
  return (
    ...
    <section >
      ...
      <div className="product">
        <div className="product-img">
          ...
          <figure tabIndex={9} aria-label={i18n.gettext(` imagen de ${title}`)}>
            <Image src={pictures[mainImage].secure_url} alt={i18n.gettext("producto")} lazyload={true} className='product-img-main' />
      ...
      <div>
        ...
        <h2 tabIndex={13} aria-label={i18n.gettext(`el producto tiene un precio de ${price}`)}>{i18n.gettext(`$ ${price}`)}</h2>

        {!quantity || !amount ? null : (
          <p tabIndex={14}>{i18n.gettext(`cuotas: ${quantity} de ${amount} cada cuota`)}</p>
        )}
